...
class Config:
    ...
    REDIRECT_UTENTE      = os.getenv("REDIRECT_UTENTE",      "http://marisa-express-server-01:3000")
    REDIRECT_RISTORATORE = os.getenv("REDIRECT_RISTORATORE", "http://marisa-express-server-01:3002")
    REDIRECT_RIDER       = os.getenv("REDIRECT_RIDER",       "http://marisa-express-server-01:3003")
