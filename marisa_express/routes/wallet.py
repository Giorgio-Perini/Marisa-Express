...
def ricarica_stripe():
    ...
    try:
        session = stripe.checkout.Session.create(
            ...
            mode="payment",
            success_url="http://marisa-express-server-01:3000/wallet?ricarica=ok&session_id={CHECKOUT_SESSION_ID}",
            cancel_url=f"http://marisa-express-server-01:3000/wallet?ricarica=cancel",
